...
class SOXAIData():
    def __init__(self, token):
        ...
        ```python
        from soxai_data import SOXAIData
       
        sx_data = SOXAIData(token=<Your-soxai-api-token>)
...
if __name__ == "__main__":
    token = '9WscrAcZLinH2NVj7DrzXoA-OXmbtdy9yDXpLKt0NEs'
    sx_data = SOXAIData(token)
    df = sx_data.getDetailData()
    df.plot()
